/**
 * CaseTimeline.jsx — updated to use dashboard.css
 * Drop-in replacement: same props/API, no separate .css import needed.
 */
...
const EVENT_CFG = {
  opened:    { color:"#3b82f6", badgeCls:"badge-opened",    label:"Opened"    },
  sighting:  { color:"#22d3ee", badgeCls:"badge-blue",      label:"Sighting"  },
  ai:        { color:"#f97316", badgeCls:"badge-amber",     label:"AI Match"  },
  confirmed: { color:"#a78bfa", badgeCls:"badge-confirmed", label:"Confirmed" },
  pending:   { color:"#f59e0b", badgeCls:"badge-pending",   label:"Pending"   },
  resolved:  { color:"#22c55e", badgeCls:"badge-resolved",  label:"Resolved"  },
};
  ...
  return (
    <div className="page">
      <div className="page-header">
        <div>
          <h2 className="page-title">Case Timeline</h2>
          <p className="page-sub">Chronological view of all case events and updates</p>
        </div>
      </div>
      ...
      <div className="timeline-cases">
        {CASES.map(c => {
          ...
          const lastCfg   = EVENT_CFG[lastEvent.type];
          return (
            <div key={c.id} className="timeline-case card">
              <div className="card-header">
                ...
                <span className={`badge ${lastCfg.badgeCls}`}>{lastCfg.label}</span>
              </div>
